...
public class DateFactory {
	...
	public static String changeDateFormatYMD(String dateToConvert, String DateFromat) {
		...
		try {
			...
			System.out.println("Date :" + dateToConvert + " Changed to new format : " + formateYMD(date));

			return (formateYMD(date));
